...
// Q11)오른쪽처럼 서기 년월일을 필드로 갖는 클래스를 만드세요.
...
public class Ex02_11 {
	...
	// n일 뒤의 날짜를 반환
	Ex02_11 after(int n) {
		Ex02_11 temp = new Ex02_11(this.y, this.m, this.d);
		if (n < 0)
			return (before(-n));
	...
	public static void main(String[] args) {
		...
		System.out.print("일：");
		int d = stdIn.nextInt();
		Ex02_11 date = new Ex02_11(y, m, d);

		System.out.print("몇 일 앞/뒤의 날짜를 구할까요?：");
		int n = stdIn.nextInt();

		Ex02_11 d1 = date.after(n);
		System.out.printf("%d일 뒤의 날짜는 %d년 %d월 %d일입니다.\n", n, d1.y, d1.m, d1.d);

		Ex02_11 d2 = date.before(n);
