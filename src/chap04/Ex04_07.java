...
// Q7)일반적으로 덱(deck)이라는 양방향 대기열(deque/double ended queue)은 아래 그림처럼
// 시작과 끝 지점에서 양쪽으로 데이터를 인큐하거나 디큐하는 자료구조입니다. 양방향 대기열을 구현하는
// 클래스 IntDeque를 만드세요. 이때 덱에 저장하는 데이터의 자료형은 int형으로 합니다.
